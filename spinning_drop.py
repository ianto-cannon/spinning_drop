...
z_tip = 1.915e-4 #m distance of the tip from the axis of rotation
rad_tip = 8.5e-5 #m radius of curvature at the tip

vol, z_tip, centroid, *_ = spinning_drop_profile_solver(capillary_len, rad_tip, z_tip, fname=f'data/spin.txt')
